        ...
        <section className="grid grid-cols-2 gap-4 xl:grid-cols-4">
          {[
            ...
            >
              ...
              <p className="mt-2 text-4xl font-extrabold text-slate-900">{raw ? value : value}</p>
            </article>
          ))}
        </section>
                    ...
                    >
                      ...
                      <div className="flex flex-1 flex-col p-4 space-y-2">
                        ...
                        <div className="flex items-center justify-between text-sm">
                          ...
                          <span className="text-slate-400">{reward.totalRedeemed} redeemed</span>
                        </div>
                        ...
                        <tr key={rd.id} className="hover:bg-slate-50">
                          <td className="px-5 py-4">
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                <p className="font-semibold text-slate-800">{rd.userName}</p>
                            ...
                            <div className="flex gap-2">
                              {rd.status === 'pending' && (
                                <>
                                  <button
                                    type="button"
                                    onClick={() => void handleRedemptionAction(rd.id, 'approved')}
                                  ...
                                  <button
                                    type="button"
                                    onClick={() => void handleRedemptionAction(rd.id, 'rejected')}
                              ...
                              {rd.status === 'approved' && (
                                <button
                                  type="button"
                                  onClick={() => void handleRedemptionAction(rd.id, 'fulfilled')}
